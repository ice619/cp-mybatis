...
public final class JDBCUtils {
    ...
    private static void config() {
         ...
         * 获取URL
         */
        URL = "jdbc:mysql://rm-uf6muqdsogu7h721o.mysql.rds.aliyuncs.com:3306/finance_overseas_phidev?useUnicode=true&characterEncoding=utf8&allowMultiQueries=true&zeroDateTimeBehavior=convertToNull&autoReconnect=true&useSSL=false";
        /*
         * 获取用户名
         */
        username = "finance_phidev";
        /*
         * 获取密码
         */
        password = "9hsJ6UlghiRAqUF";
        /*
     ...
     * @param closeable
     */
    private static void release(Object closeable){
        if(closeable != null){
